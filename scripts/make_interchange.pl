...
$file_smasch_taxon_id = "../smasch_taxon_ids.txt";
...
$file_current_names = "current_names.txt"; #Synonyms accumulated; maintained by hand, update this before running this script
$file_corrections = "I_XW.txt"; #Mapping of name variants from other floras; maintained by hand
...
$file_cnps_taxon_id = "CNPS_taxon_ids.txt"; #CNPS links; generated by script [name getCNPS???] from CNPS website, file outdated, needs created.. not sure what this if for..
